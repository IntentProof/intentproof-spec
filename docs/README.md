...
| [**certificate-issuance-policy.md**](certificate-issuance-policy.md) | When **`conformance-certificate.json`** may be issued or denied; rollout, signing, **key rotation / revocation**, and **operator verification**. |
