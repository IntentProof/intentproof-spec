...
| [**conformance_certificate_v2_migration.md**](conformance_certificate_v2_migration.md) | Cutover notes: **`v2`** default in **`spec.json`**, tooling defaults, SDK pins (**completed for current pins**). |
| [**../docs/certification-rfc.md**](../docs/certification-rfc.md) | Certificate artifact family: goals, trust model (**draft**; **`conformance_certificate.v2`** is normative in repo). |
